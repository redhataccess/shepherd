...
PortalTour.prototype.translateTour = function() {
    ...
    for (var i = 0; i < this.currentTour.steps.length; i++) {
        this.currentTour.steps[i].intro = langObj[this.currentTour.steps[i].message];
    }
};
